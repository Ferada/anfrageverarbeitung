...
public class SimpleSQLParser implements SimpleSQLParserConstants {
  ...
  final public CompilationStatements CompilationStatements() throws ParseException {
    trace_call("CompilationStatements");
    try {
   NodeListOptional n0 = new NodeListOptional();
   CompilationStatement n1;

   {
      ...
      while (true) {
        ...
        n1 = CompilationStatement();
        n0.addNode(n1);
      }
     n0.nodes.trimToSize();
     {if (true) return new CompilationStatements(n0);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("CompilationStatements");
    }
  }

  final public CompilationStatement CompilationStatement() throws ParseException {
    trace_call("CompilationStatement");
    try {
   CompilationUnit n0;
   NodeToken n1;
   Token n2;

   {
     ...
     {if (true) return new CompilationStatement(n0,n1);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("CompilationStatement");
    }
  }
  ...
  final public Literals Literals() throws ParseException {
    trace_call("Literals");
    try {
   LiteralExpression n0;
   NodeListOptional n1 = new NodeListOptional();
   NodeSequence n2;
   NodeToken n3;
   Token n4;
   LiteralExpression n5;

   {
   }
      n0 = LiteralExpression();
      label_6:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
        ...
        n4 = jj_consume_token(COMMA);
               n3 = JTBToolkit.makeNodeToken(n4);
        n2.addNode(n3);
        n5 = LiteralExpression();
        n2.addNode(n5);
        n1.addNode(n2);
      }
     n1.nodes.trimToSize();
     {if (true) return new Literals(n0,n1);}
    throw new Error("Missing return statement in function");
    } finally {
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0xd602000,0xd602000,0x8000,0x0,0x0,0x0,0x100000,0x10000,0x0,0x20000,0x0,0x0,0x0,0x0,0x0,0x0,0x8000,0x0,0x8000,0x0,0x0,0x0,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x4000,0x8000,0x4000,0x0,0x0,0x1000,0x0,0x2000,0x3f0000,0x3f0000,0x8000,0x100,0x4000,0x0,0x4000,0x0,0x1000,0x4000,0x4000,};
   }
